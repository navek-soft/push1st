...
class Pusher(pysher.Pusher, object):
    IsConnected = False
    ChannelsMap = []
    SessionId = None
    def __init__(self, appkey, host="",port=6001, secure=False, user_data=None, log_level=logging.NOTSET, reconnect_interval=10):
        super().__init__(appkey, secure = secure, custom_host=host, user_data = user_data, log_level = log_level, port = port, reconnect_interval=reconnect_interval)
