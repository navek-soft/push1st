...
protected:
	virtual ssize_t WsUpgrade(const inet::csocket& fd, const http::uri_t& path, const http::headers_t& headers);
	virtual inet::socket_t OnWsUpgrade(const inet::csocket& fd, const http::uri_t& path, const http::headers_t& headers) override;
