...
class cwsconnection : public http::cwebsocket {
   ...
   protected:
    ...
    virtual void OnWsMessage([[maybe_unused]] websocket_t::opcode_t opcode, [[maybe_unused]] const std::shared_ptr<uint8_t[]>& message, [[maybe_unused]] size_t length) {
        ;
    }
