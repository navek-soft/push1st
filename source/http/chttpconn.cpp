...
ssize_t chttpconnection::HttpReadRequest(const inet::socket_t& fd, std::string_view& method, http::uri_t& path, http::headers_t& headers, std::string& request, std::string_view& content, size_t max_size) {
...
ssize_t chttpconnection::HttpWriteRequest(const inet::socket_t& fd, const std::string_view& method, const std::string_view& uri, std::unordered_map<std::string_view, std::string>&& headers, const std::string& request) {
    std::string reply;
...
ssize_t chttpconnection::HttpWriteResponse(const inet::socket_t& fd, const std::string_view& code, const std::string& response, std::unordered_map<std::string_view, std::string>&& headers) {
    std::string reply;
