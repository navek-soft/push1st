...
std::shared_ptr<cchannel> cchannels::Register(const channel_t& type, const app_t& app, const std::string& name) {
...
cchannels::cchannels(const std::shared_ptr<ccluster>& cluster) : Cluster {cluster} {}
