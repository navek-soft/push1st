...
std::string_view http::GetMessage(std::string_view code) {
	static std::string_view unsupported_code{ "Unknown HTTP error" };
	static const std::unordered_map<std::string_view, std::string_view> response_codes{
		...
		{ "306", "Reserved" }, { "307", "Temporary Redirect" }, { "308", "Permanent Redirect" },
		...
		{ "419", "Authentication Timeout" }, { "422", "Unprocessable Entity" }, { "423", "Locked" },
